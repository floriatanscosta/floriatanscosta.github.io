document.addEventListener("DOMContentLoaded", async function () {
    ...
    try {
        ...
        const paginasValidas = ["index", "testes", "atuacao", "design", "vida-de-cientista", "destaques", "educacao", "metricas", "testes", "historico", "premiacoes", "sobre", "formacao", "publicacoes", "contato", "contato-2", "arquivos", "projetos", "experiencia"];
